...
TBLPROPERTIES ("dynamodb.table.name" = "Twitter", "dynamodb.column.mapping" = "country:country, country_code:county_code, favorites_count:favorites_count, friends_count:friends_count, full_name:full_name, id:id, it_atr:it_atr, lang:lang, name:name, place_type:place_type, screen_name:screen_name,SequenceNumber:SequenceNumber, source:source, statuses_count:statuses_count, text:text, time_zone:time_zone");
